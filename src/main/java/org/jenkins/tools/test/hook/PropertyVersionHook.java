...
public abstract class PropertyVersionHook extends PluginCompatTesterHookBeforeExecution {
    ...
    /**
     * The minimum version needed, as provided by the user or falling back to the default value provided by {@link #getDefaultMinimumVersion()}. The version will be dynamically updated to this version (but only
     * if necessary).
     */
