 ...
 */
public abstract class PropertyVersionHook extends PluginCompatTesterHookBeforeCompile {
     ...
     */
    public final String getMinimumVersion(@NonNull BeforeCompilationContext context) {
